...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-6">
            ...
            <a href="{{ route('pos.hardware.index') }}" class="flex items-center gap-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition">
                ...
                <div>
                    <h3 class="font-semibold text-gray-900">হার্ডওয়্যার সেটআপ</h3>
                    <p class="text-sm text-gray-600">ডিভাইস কনফিগার করুন</p>
                </div>
            </a>
        </div>
    </div>
